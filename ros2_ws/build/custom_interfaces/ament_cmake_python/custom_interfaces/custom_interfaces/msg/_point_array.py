    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'custom_interfaces.msg.PointArray')
            logger.debug(
...
class PointArray(metaclass=Metaclass_PointArray):
    ...
    _fields_and_field_types = {
        'point_array': 'sequence<geometry_msgs/Point>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.point_array = kwargs.get('point_array', [])
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.point_array != other.point_array:
            return False
        return True
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'point_array' field must be a set or sequence and each value of type 'Point'"
        self._point_array = value
